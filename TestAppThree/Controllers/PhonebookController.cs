...
namespace TestAppThree.Controllers
{
    public class PhonebookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerID,CustomerName,UserName,Phone")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerID,CustomerName,UserName,Phone")] Customer customer)
        {
